...
async function initializeProject() {
  ...
  vscode.window.showInformationMessage('Initializing the perfect project structure... one file at a time.');
...
// Function to initialize the folder structure and files based on the template
function initialize(template, projectName) {
  const workspacePath = vscode.workspace.rootPath;

  if (!workspacePath) {
    vscode.window.showErrorMessage('Please open a folder to initialize the project.');
    return;
  }
